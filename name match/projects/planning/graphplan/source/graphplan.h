...
#define MAXMAXNODES 102400  /* max number of nodes per layer of graph */
#define NUMINTS 3200 /* MAXMAXNODES / 32 */
#define HSIZE 5000   /* For simplicity, fix hash table to have size HSIZE */
#define MAX_TOKENS 1500 /* max number of tokens in a tokenlist */
#define MAXGOALS 5000   /* max size of a goal set */
#define max_auto 20000  /* arbitrary max #time steps for making graph */
